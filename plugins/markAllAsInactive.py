...
class markAllAsInactive(reportProvider):
    """Report provider wrapper for the ECOSAR widget."""

    def __init__(self,inputTuple):
        super(markAllAsInactive,self).__init__(inputTuple)
        self.reportType = 'Mark datapoints as inactive'
    ...
    def displayReport(self):
        ...
        sureMsg.setText('Are you sure you want to mark all datapoints of this type as inactive for all visible chemicals?')
        ...
        if sureMsgOut == QtGui.QMessageBox.Ok:
            ...
            self.parent.cv.markAllAsInactive(selectedTi)
            return
        else:
            return 
